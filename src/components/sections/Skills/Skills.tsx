...
const [activeCategory, setActiveCategory] = useState<string | null>(null);
  ...
  return (
    <section
      id="skills"
      className="mx-auto w-full max-w-6xl px-6 py-24 min-h-lvh flex flex-col justify-center"
    >
      ...
      <div className="relative min-h-[670px] space-y-4 mb-30" onMouseLeave={() => setActiveCategory(null)}>
